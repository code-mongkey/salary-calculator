...
namespace Utilities
{
    public class INIFile
    {
        ...
        {
            mPath = System.IO.Path.GetFullPath(path);
        }
                                ...
                                string defaultValue)
        {
            ...
            NativeMethods.GetPrivateProfileString(sectionName, keyName, defaultValue, retval, INIFile.MaxSectionSize, mPath);
        ...
        public int GetInt32(string sectionName, string keyName, int defaultValue)
        {
            ...
            return NativeMethods.GetPrivateProfileInt(sectionName, keyName, defaultValue, mPath);
        }
        ...
        public List<KeyValuePair<string, string>> GetSectionValuesAsList(string sectionName)
        {
            ...
            try
            {
                ...
                int len = NativeMethods.GetPrivateProfileSection(sectionName, ptr, INIFile.MaxSectionSize, mPath);
        ...
        public string[] GetKeyNames(string sectionName)
        {
            ...
            try
            {
                ...
                len = NativeMethods.GetPrivateProfileString(sectionName, null, null, ptr, INIFile.MaxSectionSize, mPath);
        ...
        public string[] GetSectionNames()
        {
            ...
            {
                //Get the section names into the buffer.
                len = NativeMethods.GetPrivateProfileSectionNames(ptr, INIFile.MaxSectionSize, mPath);
                retval = ConvertNullSeperatedStringToStringArray(ptr, len);
            }
            finally
            {
        ...
        {
            if (!NativeMethods.WritePrivateProfileString(sectionName, keyName, value, mPath))
            {
